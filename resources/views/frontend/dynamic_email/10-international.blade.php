@php
    $fallbackHeroImage = 'https://attariclasses.in/email-image/CCNAInternational.png';
                    ...
                    <tr>
                        <td align="center" style="padding:12px; background-color: #fff;">
                            ...
                            <a href="{{ $emailTemplateData['youtube_url'] }}" target="_blank">
                                <img src="{{ dynamic_email_youtube_image_url($emailTemplateData['course_id'], $emailTemplateData['type']) }}" alt="Video Thumbnail" width="405" style=" border:1px solid #cccccc69; width:100%; max-width:405px; border-radius:30px;">
                            </a>
                        </td>
                    </tr>
