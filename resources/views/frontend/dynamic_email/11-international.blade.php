@php
    $fallbackHeroImage = 'https://attariclasses.in/email-image/newwshinter.png';
        ...
        <tr>
            <td align="center" style="padding: 20px 0;">
                <table bgcolor="#ffffff" width="600" cellpadding="0" cellspacing="0" border="0" style="margin:0 auto; border-radius: 8px; overflow: hidden;">
					...
					<tr>
                        <td align="center" style="padding:16px 24px 6px 24px; background-color:#ffffff;">
                    ...
                    <tr>
                        <td style="padding:0 24px; background-color:#ffffff;">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
                                <tr>
                                    <td style="padding:18px 0 13px 0;">
